...
public class PathFinder {
	...
	public static void setMapSize( int width, int height ) {
		...
		dir = new int[]{-1, +1, -width, +width, -1, +1, -width, +width};
		dirLR = new int[]{-width, -1, -width, -width, +width, +width, +1, +width};

		NEIGHBOURS4 = new int[]{-width, -1, +1, +width};
		NEIGHBOURS8 = new int[]{-width, -1, +1, +width, -width, -1, +1, +width};
		NEIGHBOURS9 = new int[]{-width, -1, 0, +1, +width, -width, -1, 0, +1};
